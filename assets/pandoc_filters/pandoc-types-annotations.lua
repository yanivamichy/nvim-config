...
Based on: https://github.com/massifrg/pandoc-luals-annotations
]]
--
...
---@type string Output format (e.g. 'latex', 'html5', 'native')
FORMAT = ''
...
---@type string Path to the current filter script
PANDOC_SCRIPT_FILE = ''
